  ...
  return (
    <Container style={{ fontFamily: "Shrikhand" }}>
      ...
      <Row style={{ width: "20rem" }}>
        <Col>
          <Button className="white-button">S</Button>
        </Col>
        <Col>
          <Button className="white-button">M</Button>
        </Col>
        <Col>
          <Button className="white-button">L</Button>
        </Col>
        <Col>
          <Button className="white-button">XL</Button>
        </Col>
      </Row>
      <Row className="pt-4">
        <Col>
